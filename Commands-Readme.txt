...
* Mandatory: Before final submission run the following commands to execute testcases
	...
	python manage.py test notesapp.test.test_functional
	python manage.py test notesapp.test.test_exceptional
	python manage.py test notesapp.test.test_boundary
